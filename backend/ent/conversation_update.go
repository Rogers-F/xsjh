...
func (_u *ConversationUpdate) SetClientConversationID(v string) *ConversationUpdate {
	_u.mutation.SetClientConversationID(v)
	return _u
}

// SetNillableClientConversationID sets the "client_conversation_id" field if the given value is not nil.
func (_u *ConversationUpdate) SetNillableClientConversationID(v *string) *ConversationUpdate {
	if v != nil {
		_u.SetClientConversationID(*v)
	}
	return _u
}
...
func (_u *ConversationUpdate) check() error {
	if v, ok := _u.mutation.ClientConversationID(); ok {
...
func (_u *ConversationUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.ClientConversationID(); ok {
...
// SetClientConversationID sets the "client_conversation_id" field.
func (_u *ConversationUpdateOne) SetClientConversationID(v string) *ConversationUpdateOne {
	_u.mutation.SetClientConversationID(v)
	return _u
}

// SetNillableClientConversationID sets the "client_conversation_id" field if the given value is not nil.
func (_u *ConversationUpdateOne) SetNillableClientConversationID(v *string) *ConversationUpdateOne {
	if v != nil {
		_u.SetClientConversationID(*v)
	}
	return _u
