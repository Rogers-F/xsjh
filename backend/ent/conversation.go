...
type Conversation struct {
	...
	// Client-generated identifier used for idempotent creation
...
func (_m *Conversation) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case conversation.FieldClientConversationID:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field client_conversation_id", values[i])
			} else if value.Valid {
				_m.ClientConversationID = value.String
			}
...
func (_m *Conversation) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("client_conversation_id=")
	builder.WriteString(_m.ClientConversationID)
	builder.WriteString(", ")
