export default {
  ...
  admin: {
    ...
    payg: {
      title: 'PAYG 钱包',
      description: '查看用户充值、订单状态和累计入账情况',
      disabledTitle: 'PAYG 钱包未启用',
      disabledDescription: '请先在系统设置中启用 PAYG 并配置收钱吧参数。',
      totalOrders: '订单总数',
      paidOrders: '已支付订单',
      pendingOrders: '待支付订单',
    ...
    users: {
      ...
      commissionRate: {
        action: '佣金率',
        title: '设置用户佣金率',
        description: '为 {email} 单独设置返佣比例；不设置时继承系统全局佣金率。',
        globalRate: '全局佣金率',
        userRate: '用户专属佣金率',
        effectiveRate: '当前生效佣金率',
        inherited: '继承全局',
        useGlobal: '使用全局佣金率',
        useCustom: '设置专属佣金率',
        customRateLabel: '专属佣金率',
        customRatePlaceholder: '例如 15',
        customRateHint: '请输入 0-100 之间的百分比数值。',
        invalidRate: '请输入 0 到 100 之间的佣金率',
        loadFailed: '加载佣金率失败',
        saveSuccess: '佣金率更新成功',
        saveFailed: '更新佣金率失败'
      },
    ...
    settings: {
      ...
      payg: {
        title: 'PAYG 钱包',
        description: '配置项目内置的钱包充值入口，保留原有充值/订阅页并行存在',
        builtInHint: '该入口是项目内置钱包充值功能，不会替换你现有的 /purchase 充值/订阅页面。',
        enabled: '启用 PAYG 钱包',
        enabledHint: '启用后，用户侧会显示钱包入口，管理员侧会显示 PAYG 总览。',
        exchangeRate: '汇率倍率',
        exchangeRateHint: '用户每充值 1 元人民币，按此倍率折算为钱包余额，例如 7.20 表示 1 CNY = 7.20 USD 余额。',
        exchangeRateInvalid: 'PAYG 汇率倍率必须大于 0',
        fixedAmountOptions: '固定充值金额',
        fixedAmountOptionsPlaceholder: '例如：10, 20, 50, 100',
        fixedAmountOptionsHint: '使用英文逗号、中文逗号或空格分隔，前端会展示为快捷充值按钮。',
        fixedAmountOptionsInvalid: '固定充值金额格式不正确，请输入大于 0 的数字并使用逗号或空格分隔',
        terminalSn: '收钱吧终端号',
        terminalSnPlaceholder: '请输入收钱吧终端号',
        terminalSnHint: '启用 PAYG 时必填，用于调用收钱吧预下单与查单接口。',
        terminalSnRequired: '启用 PAYG 时必须填写收钱吧终端号',
        terminalKey: '收钱吧终端密钥',
        terminalKeyPlaceholder: '请输入收钱吧终端密钥',
        terminalKeyHint: '首次启用 PAYG 时必填，请妥善保管。',
        terminalKeyConfiguredPlaceholder: '已配置，留空则保持当前密钥',
        terminalKeyConfiguredHint: '当前密钥已配置，留空表示不修改。',
        terminalKeyRequired: '启用 PAYG 时必须填写收钱吧终端密钥'
      },
      customMenu: {
        title: '自定义菜单页面',
  ...
  wallet: {
    title: '钱包',
    description: '查看余额、创建充值订单并跟踪到账状态',
    disabledTitle: 'PAYG 钱包未启用',
    disabledDescription: '管理员暂未启用 PAYG 钱包，请联系管理员。',
    balance: '当前余额',
    totalPaid: '累计支付金额',
    totalCredited: '累计入账金额',
    totalConsumption: '累计消费金额',
    rechargeTitle: '钱包充值',
    rechargeDescription: '当前汇率倍率为 {rate}，充值成功后会按该倍率增加钱包余额。',
    builtInHint: '这是项目内置钱包充值能力，充值后会直接进入当前账号钱包余额。',
    fixedAmounts: '快捷金额',
    customAmount: '自定义金额',
    ...
    wechat: '微信支付',
    selectedAmount: '当前选择',
    noAmountSelected: '未选择金额',
    creditPreview: '预计到账',
    creatingOrder: '创建订单中...',
    createOrder: '创建支付订单',
    currentOrder: '当前订单',
    currentOrderHint: '创建订单后可在此查看二维码并轮询支付结果。',
    orderNo: '订单号',
    orderAmount: '支付金额',
    creditAmount: '到账金额',
    qrCodeAlt: '支付二维码',
    qrCodeHint: '请使用对应支付方式扫码完成付款，系统会自动同步支付结果。',
    qrCodeUnavailable: '当前订单暂未返回支付二维码',
    copyPaymentCode: '复制支付链接',
    syncingOrder: '同步订单中...',
    refreshOrder: '刷新订单',
    noActiveOrder: '暂无进行中的充值订单',
    orderHistory: '订单历史',
    noOrders: '暂无充值记录',
    createdAt: '创建时间',
    statusPaid: '已支付',
  ...
  playground: {
    title: '操练场',
    description: '在线测试 API Key 的对话沙盒',
    pickers: {
      group: '分组',
      apiKey: 'API 密钥',
      model: '模型',
      ...
      selectModel: '请选择模型',
      noKeysForGroup: '该分组下还没有密钥',
      createPlaygroundKey: '创建操练场密钥',
      creatingKey: '创建中...',
      keyCreated: '操练场密钥已创建',
      keyCreateFailed: '密钥创建失败',
      keyDefaultName: '操练场（自动创建）',
      modelEmpty: '先选择密钥以加载模型',
      modelLoading: '加载模型中...',
      refreshModels: '刷新模型',
      preview: '掩码'
    },
    chat: {
      ...
      streamToggle: '流式',
      clearAll: '清空对话',
      clearConfirmTitle: '清空所有消息？',
      clearConfirmBody: '将会删除当前对话，此操作无法撤销。',
      roleUser: '你',
      roleAssistant: '助手',
      roleSystem: '系统',
      reasoning: '思考过程',
    ...
    errors: {
      ...
      sendFailed: '发送失败',
      noKeySelected: '请先选择 API 密钥',
      noModelSelected: '请先选择模型',
      requestAborted: '请求已停止',
