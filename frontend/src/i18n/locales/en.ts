export default {
  ...
  auth: {
    ...
    accountPlaceholder: 'Enter your email or username',
    accountRequired: 'Email or username is required',
  ...
  admin: {
    ...
    payg: {
      title: 'PAYG Wallet',
      description: 'Review user recharges, order states, and credited balances',
      disabledTitle: 'PAYG wallet is disabled',
      disabledDescription: 'Enable PAYG and configure Shouqianba credentials in system settings first.',
      ...
      alipay: 'Alipay',
      wechat: 'WeChat Pay',
      loadFailed: 'Failed to load PAYG data'
    },
    ...
    users: {
      ...
      commissionRate: {
        ...
        title: 'Set User Commission Rate',
        description: 'Set a custom referral commission rate for {email}, or inherit the global rate.',
        globalRate: 'Global Rate',
        userRate: 'User Custom Rate',
        effectiveRate: 'Effective Rate',
        inherited: 'Inherit global rate',
        useGlobal: 'Use Global Rate',
        useCustom: 'Set Custom Rate',
        customRateLabel: 'Custom Rate',
        customRatePlaceholder: 'For example 15',
        customRateHint: 'Enter a percentage value between 0 and 100.',
        invalidRate: 'Please enter a commission rate between 0 and 100',
        loadFailed: 'Failed to load commission rate',
        saveSuccess: 'Commission rate updated successfully',
        saveFailed: 'Failed to update commission rate'
      },
    ...
    settings: {
      ...
      payg: {
        title: 'PAYG Wallet',
        description: 'Configure the built-in wallet recharge flow while keeping the existing recharge/subscription page',
        builtInHint: 'This is the built-in wallet recharge flow. It does not replace your existing /purchase recharge/subscription page.',
        enabled: 'Enable PAYG Wallet',
        enabledHint: 'When enabled, users will see a wallet entry and admins will see the PAYG overview page.',
        exchangeRate: 'Exchange Rate',
        exchangeRateHint: 'How much wallet balance is credited for every 1 CNY paid. For example, 7.20 means 1 CNY = 7.20 wallet balance.',
        exchangeRateInvalid: 'PAYG exchange rate must be greater than 0',
        fixedAmountOptions: 'Fixed Recharge Amounts',
        fixedAmountOptionsPlaceholder: 'e.g. 10, 20, 50, 100',
        fixedAmountOptionsHint: 'Separate values with commas, Chinese commas, or spaces. They will be shown as quick amount buttons.',
        fixedAmountOptionsInvalid: 'Invalid fixed recharge amounts. Enter numbers greater than 0 separated by commas or spaces.',
        terminalSn: 'Shouqianba Terminal SN',
        terminalSnPlaceholder: 'Enter the Shouqianba terminal SN',
        terminalSnHint: 'Required when PAYG is enabled. Used for precreate and query requests.',
        terminalSnRequired: 'Shouqianba terminal SN is required when PAYG is enabled',
        terminalKey: 'Shouqianba Terminal Key',
        terminalKeyPlaceholder: 'Enter the Shouqianba terminal key',
        terminalKeyHint: 'Required the first time PAYG is enabled. Keep it secure.',
        terminalKeyConfiguredPlaceholder: 'Already configured, leave blank to keep the current key',
        terminalKeyConfiguredHint: 'A terminal key is already configured. Leave blank to keep it unchanged.',
        terminalKeyRequired: 'Shouqianba terminal key is required when PAYG is enabled'
      },
      customMenu: {
  ...
  wallet: {
    title: 'Wallet',
    description: 'Check balance, create recharge orders, and track payment status',
    disabledTitle: 'PAYG wallet is disabled',
    disabledDescription: 'The administrator has not enabled the PAYG wallet yet.',
    balance: 'Current Balance',
    totalPaid: 'Total Paid Amount',
    totalCredited: 'Total Credited Amount',
    totalConsumption: 'Total Consumption',
    rechargeTitle: 'Recharge Wallet',
    rechargeDescription: 'Current exchange rate is {rate}. Successful payments will credit your wallet using this rate.',
    builtInHint: 'This is the built-in wallet recharge flow. Successful payments are credited directly to your current account wallet.',
    fixedAmounts: 'Quick Amounts',
    customAmount: 'Custom Amount',
    customAmountPlaceholder: 'Enter recharge amount (CNY)',
    paymentMethod: 'Payment Method',
    alipay: 'Alipay',
    wechat: 'WeChat Pay',
    selectedAmount: 'Selected Amount',
    noAmountSelected: 'No amount selected',
    creditPreview: 'Credit Preview',
    creatingOrder: 'Creating order...',
    createOrder: 'Create Payment Order',
    currentOrder: 'Current Order',
    currentOrderHint: 'After creating an order, scan the QR code here and sync the payment result.',
    orderNo: 'Order No.',
    orderAmount: 'Paid Amount',
    creditAmount: 'Credited Amount',
    qrCodeAlt: 'Payment QR code',
    qrCodeHint: 'Scan with the selected payment method. The system will sync the payment result automatically.',
    qrCodeUnavailable: 'No payment QR code is available for the current order yet',
    copyPaymentCode: 'Copy Payment Link',
    syncingOrder: 'Syncing order...',
    refreshOrder: 'Refresh Order',
    noActiveOrder: 'No active recharge order',
    orderHistory: 'Order History',
    noOrders: 'No recharge records yet',
    createdAt: 'Created At',
    statusPaid: 'Paid',
    statusClosed: 'Closed',
    statusPending: 'Pending',
    loadFailed: 'Failed to load wallet',
    invalidAmount: 'Please enter a recharge amount greater than 0',
  ...
  // Playground (interactive chat sandbox)
  playground: {
    title: 'Playground',
    description: 'Interactive chat sandbox to test your API keys',
    pickers: {
      group: 'Group',
      apiKey: 'API Key',
      model: 'Model',
      ...
      noKeysForGroup: 'No API key in this group yet',
      createPlaygroundKey: 'Create Playground key',
      creatingKey: 'Creating...',
      keyCreated: 'Playground key created',
      keyCreateFailed: 'Failed to create key',
      keyDefaultName: 'Playground (auto-created)',
      modelEmpty: 'Select a key first to load models',
      modelLoading: 'Loading models...',
      refreshModels: 'Refresh models',
      preview: 'masked'
    },
    chat: {
      empty: 'Pick a model and start chatting',
      ...
      streamToggle: 'Stream',
      clearAll: 'Clear chat',
      clearConfirmTitle: 'Clear all messages?',
      clearConfirmBody: 'This will delete the current conversation. This cannot be undone.',
      roleUser: 'You',
    ...
    errors: {
      ...
      noKeySelected: 'Please select an API key first',
