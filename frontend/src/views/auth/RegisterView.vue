    ...
    <div class="space-y-6">
      ...
      <form v-else @submit.prevent="handleRegister" class="space-y-5">
        ...
        <div>
          ...
          <div class="relative">
            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
              <Icon name="lock" size="md" class="text-dust-400 dark:text-pearl-400" />
            </div>
            <input
              id="password"
            ...
            <button
              ...
              class="absolute inset-y-0 right-0 flex items-center pr-3.5 text-dust-400 transition-colors hover:text-dust-600 dark:text-pearl-400 dark:hover:text-pearl-200"
            >
        ...
        <div>
          <label for="referral_code" class="input-label">
            ...
            <span class="ml-1 text-xs font-normal text-dust-400 dark:text-pearl-400">({{ t('common.optional') }})</span>
          </label>
          <div class="relative">
            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
              <Icon name="userPlus" size="md" class="text-dust-400 dark:text-pearl-400" />
            </div>
            <input
              id="referral_code"
        ...
        <div v-if="invitationCodeEnabled">
          ...
          <div class="relative">
            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
              <Icon name="key" size="md" :class="invitationValidation.valid ? 'text-mint-500' : 'text-dust-400 dark:text-pearl-400'" />
            </div>
            <input
              id="invitation_code"
              ...
              :class="{
                'border-mint-500 focus:border-mint-500 focus:ring-mint-500': invitationValidation.valid,
                'border-coral-500 focus:border-coral-500 focus:ring-coral-500': invitationValidation.invalid || errors.invitation_code
              }"
            ...
            <div v-if="invitationValidating" class="absolute inset-y-0 right-0 flex items-center pr-3.5">
              <svg class="h-4 w-4 animate-spin text-dust-400 dark:text-pearl-400" fill="none" viewBox="0 0 24 24">
          ...
          <transition name="fade">
            <div v-if="invitationValidation.valid" class="mt-2 flex items-center gap-2 rounded-lg bg-mint-500/10 px-3 py-2 dark:bg-mint-500/10">
              <Icon name="checkCircle" size="sm" class="text-mint-600 dark:text-mint-500" />
              <span class="text-sm text-mint-600 dark:text-mint-500">
        ...
        <div v-if="promoCodeEnabled">
          ...
          <div class="relative">
            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
              <Icon name="gift" size="md" :class="promoValidation.valid ? 'text-mint-500' : 'text-dust-400 dark:text-pearl-400'" />
            </div>
            <input
              id="promo_code"
              ...
              class="input pl-11 pr-10"
              :class="{
                'border-mint-500 focus:border-mint-500 focus:ring-mint-500': promoValidation.valid,
                'border-coral-500 focus:border-coral-500 focus:ring-coral-500': promoValidation.invalid
              }"
          ...
          <transition name="fade">
            <div v-if="promoValidation.valid" class="mt-2 flex items-center gap-2 rounded-lg bg-mint-500/10 px-3 py-2 dark:bg-mint-500/10">
              <Icon name="gift" size="sm" class="text-mint-600 dark:text-mint-500" />
              <span class="text-sm text-mint-600 dark:text-mint-500">
