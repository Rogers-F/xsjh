<template>
  <div
    class="flex min-h-screen items-center justify-center bg-gradient-to-br from-paper-50 to-paper-100 p-4 dark:from-ink-900 dark:to-ink-700"
  >
    <div class="w-full max-w-2xl">
      <!-- Logo & Title -->
      <div class="mb-8 text-center">
        <div
          class="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-accent-700 to-accent-900 shadow-lg"
        >
        ...
        <div class="flex items-center justify-center">
          <template v-for="(step, index) in steps" :key="step.id">
              ...
              <div
                :class="[
                  ...
                  currentStep > index
                    ...
                    : currentStep === index
                      ? 'bg-gold-500 text-white ring-4 ring-gold-100 dark:ring-gold-500/30'
                      : 'bg-paper-200 text-dust-500 dark:bg-ink-700 dark:text-pearl-300'
                ]"
              >
                <Icon
              ...
              <span
                ...
                :class="
                  currentStep >= index
                    ...
                    : 'text-dust-400 dark:text-pearl-400'
                "
              >
                {{ step.title }}
              </span>
            ...
            <div
              ...
              :class="currentStep > index ? 'bg-gold-500' : 'bg-paper-200 dark:bg-ink-700'"
            ></div>
          </template>
        </div>
      </div>
      ...
      <!-- Step Content -->
      <div class="rounded-2xl bg-white p-8 shadow-xl dark:bg-ink-700">
        <!-- Step 1: Database -->
        <div v-if="currentStep === 0" class="space-y-6">
          ...
          <div class="flex items-center justify-between rounded-xl border border-paper-200 p-3 dark:border-ink-700">
            <div>
        ...
        <div
          v-if="errorMessage"
          class="mt-6 rounded-xl border border-coral-500/30 bg-coral-500/15 p-4 dark:border-coral-500/30 dark:bg-coral-500/15"
        >
          <div class="flex items-start gap-3">
            <Icon name="exclamationCircle" size="md" class="flex-shrink-0 text-coral-500" />
            <p class="text-sm text-coral-700 dark:text-coral-400">{{ errorMessage }}</p>
          </div>
        </div>
