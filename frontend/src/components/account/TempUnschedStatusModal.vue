  ...
  >
    <div class="space-y-4">
      <div v-if="loading" class="flex items-center justify-center py-8">
        <svg class="h-6 w-6 animate-spin text-dust-400" fill="none" viewBox="0 0 24 24">
          <circle
            class="opacity-25"
            cx="12"
            cy="12"
      ...
      <div v-else-if="!isActive" class="rounded-lg border border-paper-200 p-4 text-sm text-dust-500 dark:border-ink-600 dark:text-pearl-300">
        {{ t('admin.accounts.tempUnschedulable.notActive') }}
      </div>

      <div v-else class="space-y-4">
        <div class="rounded-lg border border-mint-500/30 bg-mint-500/10 p-3 text-sm text-mint-600 dark:border-mint-500/30 dark:bg-mint-500/10 dark:text-mint-500">
