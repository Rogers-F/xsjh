<template>
  ...
  >
    <div v-if="account" class="space-y-4">
      <!-- Account Info -->
      <div
        class="rounded-lg border border-paper-200 bg-paper-100 p-4 dark:border-ink-600 dark:bg-ink-700"
      >
      ...
      <div v-if="isGemini" class="rounded-lg border border-paper-200 bg-paper-100 p-4 dark:border-ink-600 dark:bg-ink-700">
