  ...
  <div class="flex flex-col gap-1.5">
    ...
    <div class="flex items-center gap-1.5">
      ...
      >
        ...
        <span class="text-dust-400 dark:text-pearl-400">/</span>
...
const concurrencyClass = computed(() => {
  ...
  return 'bg-paper-100 text-dust-700 dark:bg-ink-800 dark:text-dust-400'
})
...
const windowCostClass = computed(() => {
  ...
  return 'bg-mint-500/15 text-mint-600 dark:bg-mint-500/15 dark:text-mint-500'
})
