        ...
        <div class="mt-2 flex rounded-lg bg-paper-100 p-1 dark:bg-ink-700" data-tour="account-form-platform">
          ...
          <button
            ...
            :class="[
              'flex flex-1 items-center justify-center gap-2 rounded-md px-4 py-2.5 text-sm font-medium transition-all',
              form.platform === 'sora'
                ? 'bg-white text-rose-600 shadow-sm dark:bg-ink-700 dark:text-rose-400'
                : 'text-dust-700 hover:text-dust-900 dark:text-pearl-300 dark:hover:text-pearl-100'
            ]"
          >
            <svg
          ...
          <button
            ...
            :class="[
              ...
              soraAccountType === 'oauth'
                ...
                : 'border-paper-200 hover:border-rose-300 dark:border-ink-600 dark:hover:border-rose-700'
            ]"
          >
            <div
              :class="[
