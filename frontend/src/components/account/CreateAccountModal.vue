  ...
  >
        ...
        <div class="flex items-center">
          <div
            :class="[
              ...
              step >= 1 ? 'bg-gold-500 text-white' : 'bg-paper-200 text-dust-500 dark:bg-ink-700'
            ]"
          >
            1
          </div>
          <span class="ml-2 text-sm font-medium text-dust-700 dark:text-pearl-100">{{
            t('admin.accounts.oauth.authMethod')
          }}</span>
        </div>
        <div class="h-0.5 w-8 bg-paper-300 dark:bg-ink-600" />
        <div class="flex items-center">
          <div
            :class="[
              'flex h-8 w-8 items-center justify-center rounded-full text-sm font-semibold',
              step >= 2 ? 'bg-gold-500 text-white' : 'bg-paper-200 text-dust-500 dark:bg-ink-700'
            ]"
          >
            2
          </div>
    ...
    >
      ...
      <div>
        ...
        <div class="mt-2 flex rounded-lg bg-paper-100 p-1 dark:bg-ink-700" data-tour="account-form-platform">
          <button
            type="button"
            ...
            :class="[
              ...
              form.platform === 'anthropic'
                ? 'bg-white text-orange-600 shadow-sm dark:bg-ink-700 dark:text-orange-400'
                : 'text-dust-700 hover:text-dust-900 dark:text-pearl-300 dark:hover:text-pearl-100'
            ]"
          >
          ...
          <button
            ...
            :class="[
              ...
              form.platform === 'openai'
                ? 'bg-white text-green-600 shadow-sm dark:bg-ink-700 dark:text-green-400'
                : 'text-dust-700 hover:text-dust-900 dark:text-pearl-300 dark:hover:text-pearl-100'
            ]"
          >
            <svg
          ...
          <button
            ...
            :class="[
              ...
              form.platform === 'gemini'
                ? 'bg-white text-blue-600 shadow-sm dark:bg-ink-700 dark:text-blue-400'
                : 'text-dust-700 hover:text-dust-900 dark:text-pearl-300 dark:hover:text-pearl-100'
            ]"
          >
            <svg
          ...
          <button
            ...
            :class="[
              ...
              form.platform === 'antigravity'
                ? 'bg-white text-purple-600 shadow-sm dark:bg-ink-700 dark:text-purple-400'
                : 'text-dust-700 hover:text-dust-900 dark:text-pearl-300 dark:hover:text-pearl-100'
            ]"
          >
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'oauth-based'
                ...
                : 'border-paper-200 hover:border-orange-300 dark:border-ink-600 dark:hover:border-orange-700'
            ]"
          >
            <div
              :class="[
                ...
                accountCategory === 'oauth-based'
                  ...
                  : 'bg-paper-100 text-dust-500 dark:bg-ink-700 dark:text-pearl-300'
              ]"
            >
              <Icon name="sparkles" size="sm" />
            </div>
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'apikey'
                ...
                : 'border-paper-200 hover:border-purple-300 dark:border-ink-600 dark:hover:border-purple-700'
            ]"
          >
            <div
              :class="[
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'bedrock'
                ...
                : 'border-paper-200 hover:border-amber-300 dark:border-ink-600 dark:hover:border-amber-700'
            ]"
          >
            <div
              :class="[
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'oauth-based'
                ...
                : 'border-paper-200 hover:border-green-300 dark:border-ink-600 dark:hover:border-green-700'
            ]"
          >
            <div
              :class="[
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'oauth-based'
                ...
                : 'border-paper-200 hover:border-blue-300 dark:border-ink-600 dark:hover:border-blue-700'
            ]"
          >
            <div
              :class="[
        ...
        <div v-if="accountCategory === 'oauth-based'" class="mt-4">
            ...
            >
              ...
              <div class="min-w-0">
                ...
                <div class="mt-2 flex flex-wrap gap-1">
                  ...
                  <span
                    class="rounded bg-mint-500/15 px-2 py-0.5 text-[10px] font-semibold text-mint-600 dark:bg-mint-500/15 dark:text-mint-500"
                  >
                    无需 GCP
                  </span>
                </div>
          ...
          <div class="mt-3">
            <button
              ...
              class="flex items-center gap-2 text-sm text-dust-700 hover:text-dust-900 dark:text-pearl-300 dark:hover:text-pearl-100"
            >
              <svg
      ...
      <div v-if="form.platform === 'antigravity'" class="border-t border-paper-200 pt-4 dark:border-ink-600">
        ...
        <div class="mt-2 flex gap-4">
          <label class="flex cursor-pointer items-center">
            <input
              ...
              type="radio"
              value="oauth"
              class="mr-2 text-gold-600 focus:ring-gold-500"
            />
            <span class="text-sm text-dust-700 dark:text-pearl-100">{{ t('admin.accounts.types.oauth') }}</span>
          </label>
          <label class="flex cursor-pointer items-center">
            <input
              v-model="addMethod"
          ...
          <div class="mt-2 flex gap-4">
            <label class="flex cursor-pointer items-center">
              <input
                ...
                class="mr-2 text-gold-600 focus:ring-gold-500"
              />
              <span class="text-sm text-dust-700 dark:text-pearl-100">{{ t('admin.accounts.bedrockAuthModeSigv4') }}</span>
            </label>
            <label class="flex cursor-pointer items-center">
              <input
                v-model="bedrockAuthMode"
                ...
                class="mr-2 text-gold-600 focus:ring-gold-500"
              />
              <span class="text-sm text-dust-700 dark:text-pearl-100">{{ t('admin.accounts.bedrockAuthModeApikey') }}</span>
            </label>
          </div>
        </div>
  ...
  >
    <div class="space-y-6">
      ...
      <div>
        ...
        <div class="space-y-4">
          <div>
            <p class="mb-2 text-sm font-medium text-dust-700 dark:text-pearl-100">
              {{ t('admin.accounts.gemini.setupGuide.checklistTitle') }}
            </p>
            <ul class="list-inside list-disc space-y-1 text-sm text-dust-700 dark:text-pearl-300">
      ...
      <div class="border-t border-paper-200 pt-6 dark:border-ink-600">
        ...
        <div class="overflow-x-auto">
          <table class="w-full text-xs">
            <thead class="bg-paper-100 dark:bg-ink-700">
              <tr>
                <th class="px-3 py-2 text-left font-medium text-dust-700 dark:text-pearl-100">
...
const currentAuthUrl = computed(() => {
  if (form.platform === 'openai') return activeOpenAIOAuth.value.authUrl.value
...
const currentSessionId = computed(() => {
  if (form.platform === 'openai') return activeOpenAIOAuth.value.sessionId.value
...
const currentOAuthLoading = computed(() => {
  if (form.platform === 'openai') return activeOpenAIOAuth.value.loading.value
...
const currentOAuthError = computed(() => {
  if (form.platform === 'openai') return activeOpenAIOAuth.value.error.value
