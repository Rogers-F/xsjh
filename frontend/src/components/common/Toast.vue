    ...
    >
      ...
      >
        ...
        >
          <div class="p-4">
            <div class="flex items-start gap-3">
              ...
              <button
                ...
                class="-m-1 flex-shrink-0 rounded p-1 text-dust-400 transition-colors hover:bg-paper-100 hover:text-dust-600 dark:text-pearl-300 dark:hover:bg-white/[0.04] dark:hover:text-pearl-100"
          ...
          <!-- Progress bar -->
          <div v-if="toast.duration" class="h-1 bg-paper-100 dark:bg-ink-700">
            <div
