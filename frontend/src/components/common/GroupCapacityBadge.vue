  ...
  <div class="flex flex-col gap-1">
    ...
    <div class="flex items-center gap-1">
      ...
      >
        ...
        <span class="text-dust-400 dark:text-pearl-300">/</span>
...
function capacityClass(used: number, max: number): string {
  if (max > 0 && used >= max) {
    return 'bg-coral-500/10 text-coral-600 dark:bg-coral-500/10 dark:text-coral-500'
  }
  if (used > 0) {
    return 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400'
  }
  return 'bg-paper-100 text-dust-600 dark:bg-ink-700 dark:text-pearl-300'
}
</script>
