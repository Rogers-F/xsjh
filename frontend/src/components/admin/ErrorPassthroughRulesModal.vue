<template>
  ...
  >
    <div class="space-y-4">
      ...
      <div v-else class="max-h-96 overflow-auto rounded-lg border hairline-strong">
        <table class="min-w-full divide-y divide-paper-200 dark:divide-ink-700">
          ...
          <tbody class="divide-y divide-paper-200 bg-white dark:divide-ink-700 dark:bg-ink-800">
            <tr v-for="rule in rules" :key="rule.id" class="hover:bg-paper-50 dark:hover:bg-white/[0.04]">
              <td class="whitespace-nowrap px-3 py-2">
                <span class="inline-flex h-5 w-5 items-center justify-center rounded bg-paper-100 text-xs font-medium text-dust-700 dark:bg-ink-700 dark:text-pearl-200">
                  {{ rule.priority }}
                </span>
              </td>
              <td class="px-3 py-2">
              ...
              <td class="px-3 py-2">
                ...
                <div v-else class="flex flex-wrap gap-1">
                  ...
                  <span v-if="rule.platforms.length > 2" class="text-xs text-dust-500">
                ...
                <div class="text-xs space-y-0.5">
                  <div class="flex items-center gap-1">
                    <Icon
                      ...
                      size="xs"
                      :class="rule.passthrough_code ? 'text-green-500' : 'text-dust-400'"
                    />
                  ...
                  <div class="flex items-center gap-1">
                    <Icon
                      ...
                      size="xs"
                      :class="rule.passthrough_body ? 'text-green-500' : 'text-dust-400'"
                    />
                    <span class="text-dust-600 dark:text-pearl-300">
              ...
              <td class="px-3 py-2">
                <button
                  ...
                  :class="[
                    'relative inline-flex h-4 w-7 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-gold-500 focus:ring-offset-2',
                    rule.enabled ? 'bg-gold-600' : 'bg-paper-200 dark:bg-ink-700'
                  ]"
                >
                  <span
                    :class="[
              ...
              <td class="px-3 py-2">
                <div class="flex items-center gap-1">
                  <button
                    ...
                    class="p-1 text-dust-500 hover:text-gold-700 dark:hover:text-gold-200"
                    :title="t('common.edit')"
                  >
                  ...
                  <button
                    ...
                    class="p-1 text-dust-500 hover:text-coral-700 dark:hover:text-coral-500"
      ...
      <form @submit.prevent="handleSubmit" class="space-y-4">
            ...
            <div class="mt-1 space-y-2">
              ...
              >
                <input
                  ...
                  class="mt-0.5 h-3.5 w-3.5 border-paper-300 text-gold-600 focus:ring-gold-500"
                />
                <div class="flex-1">
            ...
            <div class="flex flex-wrap gap-3">
              ...
              >
                <input
                  ...
                  class="h-3.5 w-3.5 rounded border-paper-300 text-gold-600 focus:ring-gold-500"
                />
                <span class="text-xs text-dust-700 dark:text-pearl-100">{{ platform.label }}</span>
              </label>
            </div>
            ...
            <div>
              <label class="flex items-center gap-1.5">
                <input
                  ...
                  class="h-3.5 w-3.5 rounded border-paper-300 text-gold-600 focus:ring-gold-500"
                />
                <span class="text-xs font-medium text-dust-700 dark:text-pearl-100">
        ...
        <div class="flex items-center gap-1.5">
          <input
            ...
            class="h-3.5 w-3.5 rounded border-paper-300 text-yellow-600 focus:ring-yellow-500"
          />
          <span class="text-xs font-medium text-dust-700 dark:text-pearl-100">
