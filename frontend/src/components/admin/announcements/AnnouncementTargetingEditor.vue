<template>
  <div class="rounded-2xl border border-paper-200 bg-paper-50 p-4 dark:border-ink-700 dark:bg-ink-800/50">
    ...
    <div v-if="mode === 'custom'" class="mt-4 space-y-4">
      ...
      <div v-if="anyOf.length === 0" class="rounded-xl border border-dashed border-paper-300 p-4 text-sm text-dust-500 dark:border-ink-700 dark:text-pearl-300">
      ...
      <div
        ...
        :key="groupIndex"
        class="rounded-2xl border border-paper-200 bg-white p-4 shadow-sm dark:border-ink-700 dark:bg-ink-800"
      >
        ...
        <div class="mt-4 space-y-3">
          <div
            ...
            :key="condIndex"
            class="rounded-xl border border-paper-200 bg-paper-50 p-3 dark:border-ink-700 dark:bg-ink-900/30"
          >
      ...
      <div v-if="validationError" class="rounded-xl border border-coral-500/30 bg-coral-500/10 p-3 text-sm text-coral-700 dark:border-coral-500/30 dark:bg-coral-500/10 dark:text-coral-400">
        {{ validationError }}
      </div>
    </div>
  </div>
