...
import { APP_BASEPATH } from '../../constants';
        ...
        cover={
          <div
            ...
            style={{
              ...
              backgroundImage: `linear-gradient(0deg, rgba(var(--palette-primary-darkerChannel) / 80%), rgba(var(--palette-primary-darkerChannel) / 80%)), url('${APP_BASEPATH}/cover-4.webp')`,
                                ...
                                icon={
                                  payMethod.type === 'alipay' ? (
                                    ...
                                    <img
                                      src={
                                        actualTheme === 'dark'
                                          ? `${APP_BASEPATH}/waffo-logo-dark.svg`
                                          : `${APP_BASEPATH}/waffo-logo-light.svg`
                                      }
                                      alt='Waffo'
                                      style={{
                                        width: 18,
