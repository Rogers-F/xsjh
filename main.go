...
//go:embed web/xingsuan/dist
var xingsuanBuildFS embed.FS

//go:embed web/xingsuan/dist/index.html
var xingsuanIndexPage []byte
...
func main() {
	...
	router.SetRouter(server, router.ThemeAssets{
		...
		XingsuanBuildFS:   xingsuanBuildFS,
		XingsuanIndexPage: xingsuanIndexPage,
	})
