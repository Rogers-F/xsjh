...
// Xingsuan public-settings 共享默认值（model/option.go 注册与 controller 读取双侧引用，防止漂移）
const (
	XingsuanDefaultSiteSubtitle     = "AI 对话与开发者平台"
	XingsuanDefaultChatProviderMode = "newapi_bff"
)
